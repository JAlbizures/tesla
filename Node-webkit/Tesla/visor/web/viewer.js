...
'use strict';
var ruta = JSON.parse(localStorage.host);
var datos = JSON.parse(localStorage.data)[0];
var reporte = JSON.parse(localStorage.reporte);
if(reporte.tipo == "servicios"){
  var data = {
    "services" : datos
  }
  ruta += '/reportes/servicios/pdf?reporte='+ JSON.stringify(data);
}else if(reporte.tipo == "facturas"){
  var data = {
    "facturas" : datos,
    "dataReporte" : reporte
  }
  ruta += '/reportes/facturas/pdf?reporte='+ JSON.stringify(data);
}else if(reporte.tipo == "serviciosNoFacturados"){
  var data = {
    "facturas" : datos,
    "dataReporte" : reporte
  }
  ruta += '/reportes/serviciosNoFacturados/pdf?reporte='+ JSON.stringify(data);
}
var DEFAULT_URL = ruta;//'compressed.tracemonkey-pldi-09.pdf';
